...
import { ShieldCheck, Gauge, Fuel, Cog, MapPin, Calendar, ArrowLeft, CheckCircle, Award, FileText, Loader2 } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen flex flex-col bg-slate-50">
        ...
        <div className="flex-1 flex flex-col items-center justify-center">
          <p className="text-slate-600 font-bold mb-4">Vehicle not found.</p>
