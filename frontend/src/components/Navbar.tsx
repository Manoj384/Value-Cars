...
import { ShieldCheck, RotateCcw, Truck, Car as CarIcon, PlusCircle, LayoutDashboard, Search, MapPin, Phone } from 'lucide-react';
  ...
  return (
    <header className="sticky top-0 z-50 bg-white border-b border-slate-200 shadow-sm">
      ...
      <div className="bg-slate-900 text-slate-300 text-xs py-2 px-4 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          <span className="text-slate-400 flex items-center"><Phone className="w-3 h-3 mr-1" /> Support: <strong className="text-white ml-1">1800-200-VALUE</strong></span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <Link href="/" className="px-4 py-2 text-sm font-bold text-slate-700 hover:text-rose-600 transition flex items-center">
