...
const MOCK_CARS: Car[] = [
  ...
  },
  {
    ...
    is_verified_seller: true,
    images: [
      { id: 'img-7', image_url: 'https://images.unsplash.com/photo-1549399542-7e3f8b79c341?auto=format&fit=crop&w=1200&q=80', tag: 'EXTERIOR', display_order: 1, is_cover: true },
    ],
    features: [
      { id: 'f8', category: 'COMFORT', name: 'Bose 8-Speaker Audio & Ventilated Seats' },
    ],
  },
  {
    id: 'c7',
    title: '2023 Toyota Urban Cruiser Hyryder V Hybrid',
    reg_number: 'TN-01-TH-2023',
    make: 'Toyota',
    model: 'Hyryder',
    ...
    warranty_months: 12,
    status: 'PUBLISHED',
    seller_name: 'Toyota Trust',
    seller_email: 'seller@dealer.com',
    is_verified_seller: true,
    images: [
      { id: 'img-8', image_url: 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&w=1200&q=80', tag: 'EXTERIOR', display_order: 1, is_cover: true },
    ],
    features: [
      { id: 'f9', category: 'PERFORMANCE', name: 'Self-Charging Strong Hybrid 27.97 km/l' },
    ],
  },
  {
    id: 'c8',
    title: '2021 Volkswagen Taigun GT Plus 1.5 TSI DSG',
    reg_number: 'MH-12-VW-2021',
    make: 'Volkswagen',
    model: 'Taigun',
    variant: 'GT Plus 1.5 DSG',
    year: 2021,
    ...
    warranty_months: 12,
    status: 'PUBLISHED',
    seller_name: 'VW Das WeltAuto',
    seller_email: 'admin@valuecars.com',
    is_verified_seller: true,
    images: [
      { id: 'img-9', image_url: 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&w=1200&q=80', tag: 'EXTERIOR', display_order: 1, is_cover: true },
    ],
    features: [
      { id: 'f10', category: 'SAFETY', name: '5-Star GNCAP & Electronic Stability Control' },
    ],
  },
];
